...
export default function AdminCourseSubjectManagement() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-[1200px]">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6 flex-wrap">
        ...
        <Link href={`/admin/course/${courseId}`} className="hover:text-primary">Course</Link>
        <ChevronRight className="w-4 h-4" />
        <Link href={`/admin/course/${courseId}/semester/${semId}`} className="hover:text-primary">Sem {semId}</Link>
        <ChevronRight className="w-4 h-4" />
      ...
      <Tabs defaultValue="chapters">
        <TabsList className="bg-gray-100 p-1 rounded-xl">
          ...
          <TabsTrigger value="qbank" className="rounded-lg">Q-Bank</TabsTrigger>
        ...
        <TabsContent value="ai" className="mt-6">
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            ...
            <p className="text-gray-500 text-sm mb-4">Auto-generated when chapter PDFs are uploaded.</p>
